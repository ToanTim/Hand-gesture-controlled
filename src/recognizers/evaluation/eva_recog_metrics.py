...
def load_hagrid_samples(data_dir, labels, samples_per_label=50):
    ...
    if not CV2_AVAILABLE:
        raise ImportError("OpenCV is required for loading HAGRID samples. Install with: pip install opencv-python")
...
def evaluate_recognizer(recognizer, test_data, class_names=None, output_dir=None):
    """
